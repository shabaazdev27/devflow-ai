...
export default function HomePage() {
  ...
  const handleSaveSetting = async (key: string, value: string) => {
    try {
      await fetch("/api/py/workflows/settings/set", {
        method: "POST",
          ...
          {activeTab === "settings" && (
            ...
            >
              <div className="glass-panel p-8 rounded-2xl border-black/10 dark:border-white/10 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        handleSaveSetting("gemini_api_key", e.target.value);
                      }}
                      placeholder="AIzaSy..."
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        handleSaveSetting("gitlab_access_token", e.target.value);
                      }}
                      placeholder="glpat-..."
                      className="w-full bg-black/5 dark:bg-black/40 border border-black/10 dark:border-white/10 rounded-xl px-4 py-3 text-zinc-850 dark:text-[#529CCA] placeholder-zinc-400 dark:placeholder-zinc-700 outline-none focus:border-[#529CCA] text-sm font-mono"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        handleSaveSetting("google_sheets_id", e.target.value);
                      }}
                ...
                <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/5 text-xs text-zinc-500 leading-relaxed flex items-start gap-2">
